...
var sassFiles = function sassFiles() {
  ...
  if(this.preproOption === 'sass') {
    ...
    switch (this.gridOption){
      ...
      case 'jeet':
        this.fs.copy(sourceRoot + '/src-tpl/scss/base/jeet/', destRoot + '/src/scss/base/jeet/');
      break;

      default:
        this.fs.copyTpl(sourceRoot + '/src-tpl/scss/base/_grid.scss', destRoot + '/src/scss/base/_grid.scss', this.templateContext);
    }

    switch (this.mqOption){
      case 'breakpoint':
