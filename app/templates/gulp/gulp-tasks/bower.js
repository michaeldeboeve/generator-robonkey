...
<% if(underscoreOption){ %>moveFiles.push(bowerPath + 'underscore/underscore-min.js');<% } %><% if(backboneOption){ %>
...
moveFiles.push(bowerPath + 'require/require.js');<% } %><% if(jqueryOption){ %>
moveFiles.push(bowerPath + 'jquery/dist/jquery.min.js');<% } %><% if(tweenmaxOption){ %>
moveFiles.push(bowerPath + 'gsap/src/minified/TweenMax.min.js');<% } %><% if(d3jsOption){ %>
...
moveFiles.push(bowerPath + 'js-signals/dist/signals.min.js');<% } %><% if(waypointsOption && jqueryOption){ %>
moveFiles.push(bowerPath + 'waypoints/lib/jquery.waypoints.min.js');<% } %><% if(waypointsOption && !jqueryOption){ %>
moveFiles.push(bowerPath + 'waypoints/lib/noframework.waypoints.min.js');<% } %>
