...
> A [Yeoman](http://yeoman.io) front-end application generator with Jade, Sass, Gulp, Modernizr, Custom Icon Font Generator and some JavaScript and Sass Libraries to choose from.
